...
import b11 from '../assets/img/product/book11.jpg';
import b12 from '../assets/img/product/book12.jpg';
import b13 from '../assets/img/product/book13.jpg';
import b14 from '../assets/img/product/book9.jpg';
                        ...
                        <div className="tab-pane fade show active" id="list">
                            ...
                            <div className="row">
                                ...
                                <div className="product-wrapper-content">
                                    ...
                                    <h4><Link to="#">A Promised Land</Link></h4>
                                    <h6>Barack Obama</h6>
                                    <p>A riveting, deeply personal account of history in the making, from the president who inspired us to believe in the power of democracy. In the stirring, highly anticipated first volume of his presidential...</p>
                                    </div>
                            ...
                            <div className="row">
                                ...
                                <div className="product-wrapper-content">
                                    ...
                                    <h6>Trevor Noah</h6>
                                    <p>The memoir of one man’s coming-of-age, set during the twilight of apartheid and the tumultuous days of freedom that followed. Trevor Noah’s unlikely path from apartheid South Africa to the desk of The Daily Show...</p>
                                    </div>
                                    <div className="product-link">
                                    <div className="product-button">
                                        <Link to="#" title="Add to cart"><i className="fa fa-book" />Add to Bookshelf</Link>
                            ...
                            <div className="row">
                                ...
                                <div className="product-wrapper-content">
                                    ...
                                    <p>Walter Isaacson's "enthralling" (The New Yorker) worldwide bestselling biography of Apple cofounder Steve Jobs. Based on more than forty interviews with Steve Jobs conducted over two years--as well as interviews...</p>
                                    </div>
                                    <div className="product-link">
                                    <div className="product-button">
                                        <Link to="#" title="Add to cart"><i className="fa fa-book" />Add to Bookshelf</Link>
                            ...
                            <div className="row">
                                ...
                                <div className="product-wrapper-content">
                                    ...
                                    <h6>Dorothy Wickenden</h6>
                                    <p>From the author of the New York Times bestseller Nothing Daunted, The Agitators chronicles the revolutionary activities of Harriet Tubman, Frances Seward, and Martha Wright: three unlikely collaborators in the quest...</p>
                                    </div>
                                    <div className="product-link">
                                    <div className="product-button">
                                        <Link to="#" title="Add to cart"><i className="fa fa-book" />Add to Bookshelf</Link>
