...
import b11 from '../assets/img/product/book1.jpg';
import b12 from '../assets/img/product/book3.jpg';
import b13 from '../assets/img/product/book5.jpg';
import b14 from '../assets/img/product/book8.jpg';
                        ...
                        <div className="tab-pane fade show active" id="list">
                            ...
                            <div className="row">
                                ...
                                <div className="product-wrapper-content">
                                    ...
                                    <h4><Link to="#">Fierce Poise: Helen Frankenthaler and 1950s New York</Link></h4>
                                    <h6>Alexander Nemerov</h6>
                                    <p>A dazzling biography of one of the twentieth-century's most respected painters, Helen Frankenthaler, as she came of age as both an artist and a woman in the vibrant art world of 1950s New York At the dawn of the...</p>
                                    </div>
                                    <div className="product-link">
                                    <div className="product-button">
                                        <Link to="#" title="Add to cart"><i className="fa fa-book" />Add to Bookshelf</Link>
                            ...
                            <div className="row">
                                ...
                                <div className="product-wrapper-content">
                                    ...
                                    <h4><Link to="#">Wild Women and the Blues</Link></h4>
                                    <h6>Denny S. Bryce</h6>
                                    <p>A Fascinating and Innovative Novel of Historical Fiction Goodreads Debut Novel to Discover & Biggest Upcoming Historical Fiction Books Oprah Magazine, Parade, Ms. Magazine, SheReads, Bustle, BookBub, Frolic...</p>
                                    </div>
                                    <div className="product-link">
                                    <div className="product-button">
                                        <Link to="#" title="Add to cart"><i className="fa fa-book" />Add to Bookshelf</Link>
